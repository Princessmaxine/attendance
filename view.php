...
?>
<img src="<?php echo empty($result['avatar_path']) ? "uploads/blank.png" : $result['avatar_path'] ; ?>" class="rounded-circle" 
...
<br/>
    ...
    <a href="edit.php?id=<?php echo $result['attendee_id'] ?>" class="btn btn-warning">Back to the List</a>
